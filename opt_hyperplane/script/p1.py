...
from opt_hyperplane.solver.optimizer_tools import (make_decision_variable_label, 
                                                          ...
                                                          make_constraint_coeff_lhs_problem1,
...
d_var = make_decision_variable_label(3)
object_coeff = [0, 1, 0]
ub_bound = make_demand_bound(3, 1e19)
lb_bound = make_boundary_list([ -1e19, -1e19, -1e19])
...
lhs_constraint = make_constraint_coeff_lhs_problem1(dataset, 3)
